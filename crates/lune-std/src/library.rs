    ...
    */
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            #[cfg(feature = "tauri")]    Self::Tauri    => "tauri",
    ...
    */
    ...
    pub fn typedefs(&self) -> String {
    	match self {
            ...
            #[cfg(feature = "tauri")]    Self::Tauri    => lune_std_tauri::typedefs(),
    ...
    */
    ...
    pub fn module(&self, lua: Lua) -> LuaResult<LuaTable> {
        ...
        let res: LuaResult<LuaTable> = match self {
            ...
            #[cfg(feature = "tauri")]    Self::Tauri    => lune_std_tauri::module(mod_lua),
...
impl FromStr for LuneStandardLibrary {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(match low.as_str() {
            ...
            #[cfg(feature = "tauri")]    "tauri"    => Self::Tauri,
